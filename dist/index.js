...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var file, keys, includeType, ESPHOME_SCHEMA, content, yamlData, output, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                includeType = new yaml.Type('!include', { kind: 'mapping' });
                ESPHOME_SCHEMA = yaml.DEFAULT_SCHEMA.extend([includeType]);
                return [4 /*yield*/, fs_1.promises.readFile(file, 'utf8')];
            case 1:
                content = _a.sent();
                yamlData = yaml.load(content, { schema: ESPHOME_SCHEMA });
